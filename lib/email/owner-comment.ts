...
<html>
  <body style="margin:0;background:#121212;font-family:Arial,sans-serif;color:#f3e6e0;">
    <div style="max-width:640px;margin:0 auto;padding:24px;">
      ...
      <h1 style="font-size:20px;margin:0 0 12px;">New comment on a deal event</h1>
      ...
      <div style="background:#1c1c1c;border:1px solid #2a2a2a;border-radius:12px;padding:16px 20px;">
        <p style="margin:0;color:#c4b8b2;font-size:12px;">Deal</p>
        <p style="margin:4px 0 12px;">${escapeHtml(input.dealName)}</p>
        <p style="margin:0;color:#c4b8b2;font-size:12px;">Event</p>
      ...
      <p style="margin:20px 0 0;">
        <a href="${escapeHtml(input.eventUrl)}" style="display:inline-block;background:#e8b4b8;color:#121212;text-decoration:none;padding:8px 14px;border-radius:8px;font-size:13px;">View Event</a>
      </p>
    </div>
  </body>
</html>`
